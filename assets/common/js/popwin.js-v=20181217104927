var popWin = {
	...
	showWin: function(a, b, c, d) {
		...
		g = b / 2,
		h = "";
		h += '<div id="mask" style="width:100%; height:100%; position:fixed; top:0; left:0; z-inde:999999;background:#cccccc; filter:alpha(opacity=10); -moz-opacity:0.1; -khtml-opacity: 0.1; opacity:0.1;">sc.chinaz.com</div>',
